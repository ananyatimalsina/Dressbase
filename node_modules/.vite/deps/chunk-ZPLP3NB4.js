...
var useThemeDictionary = (language, theme19) => {
  const [themeDictionary, setThemeDictionary] = (0, import_react2.useState)(
    themeToDict_default(theme19, language)
  );
  const previousTheme = (0, import_react2.useRef)();
  const previousLanguage = (0, import_react2.useRef)();
...
var useGetLineProps = (themeDictionary) => (0, import_react3.useCallback)(
  (_a) => {
...
var useGetTokenProps = (themeDictionary) => {
  const styleForToken = (0, import_react4.useCallback)(
    ({ types, empty }) => {
...
var useTokenize = ({ prism, code, grammar, language }) => {
  const prismRef = (0, import_react5.useRef)(prism);
...
prism-react-renderer/dist/index.mjs:
  ...
  *)
*/
//# sourceMappingURL=chunk-ZPLP3NB4.js.map
