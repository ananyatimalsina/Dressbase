...
var fn = (e, t, r) => t in e ? un(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r;
...
function vn() {
  return Kt || (Kt = 1, function() {
    ...
    var A = false, N = false, E = false, m = false, Z = false, Q;
...
` + w[H].replace(" at new ", " at ");
        ...
        q = false, te.current = k, be(), Error.prepareStackTrace = P;
      }
    ...
    function zr(n, a, u, d, P) {
      {
        ...
        for (var C in n)
          if (k(n, C)) {
            ...
            w && !(w instanceof Error) && (Ve(P), y("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", d || "React class", u, C, typeof w), Ve(null)), w instanceof Error && !(w.message in Ht) && (Ht[w.message] = true, Ve(P), y("Failed %s type: %s", u, w.message), Ve(null));
          }
      }
    }
    ...
    function Kr(n, a) {
      if (typeof n.ref == "string" && je.current && a && je.current.stateNode !== a) {
        ...
        dt[u] || (y('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', z(je.current.type), n.ref), dt[u] = true);
      }
    }
    function Jr(n, a) {
      {
        var u = function() {
          Ft || (Ft = true, y("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", a));
        };
        u.isReactWarning = true, Object.defineProperty(n, "key", {
          get: u,
          configurable: true
        });
      }
    ...
    function Zr(n, a) {
      {
        var u = function() {
          Lt || (Lt = true, y("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", a));
        };
        u.isReactWarning = true, Object.defineProperty(n, "ref", {
          get: u,
          configurable: true
        });
      }
...
Check the top-level render call using <` + u + ">.");
    ...
    function Bt(n, a) {
      {
        ...
        if (ft(n))
          ...
          n._store && (n._store.validated = true);
        else if (n) {
          var P = F(n);
    ...
    function sn(n, a, u) {
      return Ut(n, a, u, true);
    }
    function an(n, a, u) {
      return Ut(n, a, u, false);
    }
    var cn = an, ln = sn;
    Me.Fragment = o, Me.jsx = cn, Me.jsxs = ln;
  }()), Me;
}
false ? St.exports = mn() : St.exports = vn();
var ce = St.exports;
var Y = function() {
...
var me = typeof process < "u" && process.env !== void 0 && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled";
var Er = "active";
var Rr = "data-styled-version";
var st = "6.1.8";
var At = `/*!sc*/
`;
var Dt = typeof window < "u" && "HTMLElement" in window;
var Ln = !!(typeof SC_DISABLE_SPEEDY == "boolean" ? SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== "" ? process.env.REACT_APP_SC_DISABLE_SPEEDY !== "false" && process.env.REACT_APP_SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.SC_DISABLE_SPEEDY !== void 0 && process.env.SC_DISABLE_SPEEDY !== "" ? process.env.SC_DISABLE_SPEEDY !== "false" && process.env.SC_DISABLE_SPEEDY : true);
var er = /invalid hook call/i;
    ...
    try {
      ...
      console.error = function(c) {
        for (var f = [], l = 1; l < arguments.length; l++)
          f[l - 1] = arguments[l];
        er.test(c) ? (s = false, Be.delete(o)) : i.apply(void 0, Ce([c], f, false));
      }, (0, import_react.useRef)(), s && !Be.has(o) && (console.warn(o), Be.add(o));
    } catch (c) {
...
var _r = xr ? Symbol.for("react.memo") : 60115;
var Gn = xr ? Symbol.for("react.forward_ref") : 60112;
var qn = { childContextTypes: true, contextType: true, contextTypes: true, defaultProps: true, displayName: true, getDefaultProps: true, getDerivedStateFromError: true, getDerivedStateFromProps: true, mixins: true, propTypes: true, type: true };
var Xn = { name: true, length: true, prototype: true, caller: true, callee: true, arguments: true, arity: true };
var kr = { $$typeof: true, compare: true, defaultProps: true, displayName: true, propTypes: true, type: true };
var Kn = ((vt = {})[Gn] = { $$typeof: true, render: true, defaultProps: true, displayName: true, propTypes: true }, vt[_r] = kr, vt);
function nr(e) {
...
function Tt(e, t, r) {
  if (r === void 0 && (r = false), !r && !ke(e) && !Array.isArray(e))
    return t;
  if (Array.isArray(t))
...
function Ae(e) {
  for (var t = [], r = 1; r < arguments.length; r++)
    t[r - 1] = arguments[r];
  return false ? new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(e, " for more information.").concat(t.length > 0 ? " Args: ".concat(t.join(", ")) : "")) : new Error(ro.apply(void 0, Ce([to[e]], t, false)).trim());
}
var no = function() {
  function e(t) {
...
var io = "style[".concat(me, "][").concat(Rr, '="').concat(st, '"]');
var so = new RegExp("^".concat(me, '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)'));
...
var fo = function() {
  ...
  return e.prototype.insertRule = function(t, r) {
    if (t <= this.length && t >= 0) {
      ...
      return this.element.insertBefore(o, this.nodes[t] || null), this.length++, true;
    }
    return false;
  }, e.prototype.deleteRule = function(t) {
...
var ho = function() {
  ...
  return e.prototype.insertRule = function(t, r) {
    return t <= this.length && (this.rules.splice(t, 0, r), this.length++, true);
  }, e.prototype.deleteRule = function(t) {
...
var ar = Dt;
var po = { isServer: !Dt, useCSSOMInjection: !Ln };
var Dr = function() {
  function e(t, r, o) {
    t === void 0 && (t = xe), r === void 0 && (r = {});
    var i = this;
    this.options = Y(Y({}, po), t), this.gs = r, this.names = new Map(o), this.server = !!t.isServer, !this.server && Dt && ar && (ar = false, function(s) {
  ...
  return e.registerId = function(t) {
    ...
    return r === void 0 && (r = true), new e(Y(Y({}, this.options), t), this.gs, r && this.names || void 0);
...
var yo = new Dr();
var xt = vo();
var jr = import_react.default.createContext({ shouldForwardProp: void 0, styleSheet: yo, stylis: xt });
jr.Consumer;
import_react.default.createContext(void 0);
function cr() {
  return (0, import_react.useContext)(jr);
}
var lr = function() {
  function e(t, r) {
    var o = this;
...
var Ir = function(e) {
  ...
  for (var i in e) {
    var s = e[i];
    e.hasOwnProperty(i) && !Hr(s) && (Array.isArray(s) && s.isCss || _e(s) ? o.push("".concat(ur(i), ":"), s, ";") : ke(s) ? o.push.apply(o, Ce(Ce(["".concat(i, " {")], Ir(s), false), ["}"], false)) : o.push("".concat(ur(i), ": ").concat((t = i, (r = s) == null || typeof r == "boolean" || r === "" ? "" : typeof r != "number" || r === 0 || t in Fn || t.startsWith("--") ? String(r).trim() : "".concat(r, "px")), ";")));
  }
  return o;
};
function pe(e, t, r, o) {
  ...
  if (_e(e)) {
    if (!_e(s = e) || s.prototype && s.prototype.isReactComponent || !t)
      return [e];
    var i = e(t);
    return typeof i != "object" || Array.isArray(i) || i instanceof lr || ke(i) || i === null || console.error("".concat(Tr(e), " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details.")), pe(i, t, r, o);
  }
  var s;
...
var Eo = function() {
  function e(t, r, o) {
    this.rules = t, this.staticRulesId = "", this.isStatic = false, this.componentId = r, this.baseHash = fe(wo, r), this.baseStyle = o, Dr.registerId(r);
  }
...
var Mr = import_react.default.createContext(void 0);
Mr.Consumer;
var bt = {};
...
function Ro(e, t, r) {
  ...
  function y(A, N) {
    return function(E, m, Z) {
      var Q = E.attrs, lt = E.componentStyle, ut = E.defaultProps, Le = E.foldedComponentIds, z = E.styledComponentId, ee = E.target, ue = import_react.default.useContext(Mr), We = cr(), ve = E.shouldForwardProp || We.shouldForwardProp;
      (0, import_react.useDebugValue)(z);
      ...
      for (var L in V)
        V[L] === void 0 || L[0] === "$" || L === "as" || L === "theme" && V.theme === De || (L === "forwardedAs" ? ie.as = V.forwardedAs : ve && !ve(L, oe) || (ie[L] = V[L], ve || false || Sn(L) || fr.has(L) || !Ct.has(oe) || (fr.add(L), console.warn('styled-components: it looks like an unknown prop "'.concat(L, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
      var ye = function(be, te) {
        var se = cr(), G = be.generateAndInjectStyles(te, se.styleSheet, se.stylis);
        return (0, import_react.useDebugValue)(G), G;
      }(lt, V);
      E.warnTooManyClasses && E.warnTooManyClasses(ye);
      var Ne = de(Le, z);
      return ye && (Ne += " " + ye), V.className && (Ne += " " + V.className), ie[yt(oe) && !Ct.has(oe) ? "class" : "className"] = Ne, ie.ref = Z, (0, import_react.createElement)(oe, ie);
    }(_, A, N);
  }
  y.displayName = g;
  var _ = import_react.default.forwardRef(y);
  ...
  } }), Wn(g, S), _.warnTooManyClasses = /* @__PURE__ */ function(A, N) {
    var E = {}, m = false;
    return function(Z) {
      if (!m && (E[Z] = true, Object.keys(E).length >= 200)) {
...
Example:
  ...
  }), s && Or(_, e, { attrs: true, componentStyle: true, displayName: true, foldedComponentIds: true, shouldForwardProp: true, styledComponentId: true, target: true }), _;
}
function dr(e, t) {
...
function Co(e) {
  for (var t = [], r = 1; r < arguments.length; r++)
    t[r - 1] = arguments[r];
  if (_e(e) || ke(e))
    return hr(pe(dr(at, Ce([e], t, true))));
  var o = e;
...
function _t(e, t, r) {
  ...
  var o = function(i) {
    for (var s = [], c = 1; c < arguments.length; c++)
      s[c - 1] = arguments[c];
    return e(t, r, Co.apply(void 0, Ce([i], s, false)));
  };
...
var pr = (e, t, r) => (t = !t && t !== 0 ? e : t, r = !r && r !== 0 ? e : r, t > r ? (console.error("min limit is greater than max limit"), e) : e < t ? t : e > r ? r : e);
var Fr = (e, t) => e.clientX > t.left && e.clientX < t.right && e.clientY > t.top && e.clientY < t.top + t.height;
var To = (e, t) => {
...
`;
var Ao = class extends import_react.Component {
  constructor(r) {
    super(r);
    ...
    b(this, "hasScroll", false);
    b(this, "startDragHandlePos", 0);
    b(this, "startDragMousePos", 0);
    b(this, "customScrollRef", (0, import_react.createRef)());
    b(this, "innerContainerRef", (0, import_react.createRef)());
    b(this, "customScrollbarRef", (0, import_react.createRef)());
    b(this, "scrollHandleRef", (0, import_react.createRef)());
    b(this, "contentWrapperRef", (0, import_react.createRef)());
    b(this, "adjustFreezePosition", (r2) => {
      if (!this.contentWrapperRef.current)
        return;
      const o = this.getScrolledElement(), i = this.contentWrapperRef.current;
      this.props.freezePosition && (i.scrollTop = this.state.scrollPos), r2.freezePosition && (o.scrollTop = this.state.scrollPos);
    });
    b(this, "toggleScrollIfNeeded", () => {
      const r2 = this.contentHeight - this.visibleHeight > 1;
      this.hasScroll !== r2 && (this.hasScroll = r2, this.forceUpdate());
    });
    b(this, "updateScrollPosition", (r2) => {
    ...
    b(this, "onClick", (r2) => {
      if (!this.hasScroll || !this.isMouseEventOnCustomScrollbar(r2) || this.isMouseEventOnScrollHandle(r2))
        return;
      const o = this.calculateNewScrollHandleTop(r2), i = this.getScrollValueFromHandlePosition(o);
      this.updateScrollPosition(i);
    });
    b(this, "isMouseEventOnCustomScrollbar", (r2) => {
    ...
    b(this, "isMouseEventOnScrollHandle", (r2) => {
      if (!this.scrollHandleRef.current)
        return false;
      const o = this.scrollHandleRef.current;
      return To(r2, o);
    });
    b(this, "calculateNewScrollHandleTop", (r2) => {
      const s = this.customScrollRef.current.getBoundingClientRect().top + window.pageYOffset, c = r2.pageY - s, f = this.getScrollHandleStyle().top;
      let l;
    ...
    b(this, "getScrollValueFromHandlePosition", (r2) => r2 / this.scrollRatio);
    b(this, "getScrollHandleStyle", () => {
      const r2 = this.state.scrollPos * this.scrollRatio;
      return this.scrollHandleHeight = this.visibleHeight * this.scrollRatio, {
        height: this.scrollHandleHeight,
        top: r2
      };
    });
    b(this, "adjustCustomScrollPosToContentPos", (r2) => {
      this.setState({
        scrollPos: r2
      });
    });
    b(this, "onScroll", (r2) => {
      this.props.freezePosition || (this.hideScrollThumb(), this.adjustCustomScrollPosToContentPos(r2.currentTarget.scrollTop), this.props.onScroll && this.props.onScroll(r2));
    });
    b(this, "getScrolledElement", () => this.innerContainerRef.current);
    b(this, "onMouseDown", (r2) => {
      !this.hasScroll || !this.isMouseEventOnScrollHandle(r2) || (this.startDragHandlePos = this.getScrollHandleStyle().top, this.startDragMousePos = r2.pageY, this.setState({
        onDrag: true
    ...
    b(this, "onHandleDrag", (r2) => {
      r2.preventDefault();
      const o = r2.pageY - this.startDragMousePos, i = pr(
    ...
    b(this, "onHandleDragEnd", (r2) => {
      this.setState({
        onDrag: false
      }), r2.preventDefault(), document.removeEventListener("mousemove", this.onHandleDrag), document.removeEventListener("mouseup", this.onHandleDragEnd);
    });
    ...
    b(this, "getScrollStyles", () => {
      const r2 = this.scrollbarYWidth || 20, o = this.props.rtl ? "marginLeft" : "marginRight", i = {
      ...
      return s[o] = this.scrollbarYWidth ? 0 : r2, {
        innerContainer: i,
        contentWrapper: s
      };
    });
    ...
    b(this, "getRootStyles", () => {
      const r2 = {};
      return this.props.heightRelativeToParent ? r2.height = this.props.heightRelativeToParent : this.props.flex && (r2.flex = this.props.flex), r2;
    });
    b(this, "enforceMinHandleHeight", (r2) => {
      const o = this.props.minScrollHandleHeight || 38;
      if (r2.height >= o)
        return r2;
      const i = o - r2.height, s = this.state.scrollPos / (this.contentHeight - this.visibleHeight), c = i * s, f = r2.top - c;
      return {
        height: o,
        top: f
      };
      ...
      _o,
      {
        ...
        children: ce.jsxs(
          "div",
          {
            ...
            children: [
              this.hasScroll ? ce.jsx("div", { className: "rcs-positioning", children: ce.jsx(
                Lr,
                {
...
react-custom-scroll/dist/index.es.js:
  (**
   * @license React
...
react-custom-scroll/dist/index.es.js:
   ...
   *)
*/
//# sourceMappingURL=react-custom-scroll.js.map
